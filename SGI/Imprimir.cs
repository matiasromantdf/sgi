...
namespace SGI
{
    class Imprimir
    {
        ...
        ArrayList infoCAE = new ArrayList();
        ...
        public void AddInfoCAE(string line)
        {
            infoCAE.Add(line);
        }
        ...
        private void DrawImage()
        {
            if (headerImage != null)
            {
                try
                {
                    ...
                    gfx.DrawImage(headerImage, new Point((int)1, (int)YPosition()));
            ...
            foreach (string header in headerLines)
            {
                if (header.Length > maxChar)
                {
                    ...
                    while (headerLenght > maxChar)
                    {
                        ...
                        gfx.DrawString(line, headerFont, myBrush, leftMargin, YPosition(), new StringFormat());
                    ...
                    line = header;
                    gfx.DrawString(line.Substring(currentChar, line.Length - currentChar), headerFont, myBrush, leftMargin, YPosition(), new StringFormat());
                    count++;
                }
                else
                {
                    ...
                    gfx.DrawString(line, headerFont, myBrush, XPosition, YPosition(), new StringFormat());
        ...
        private void DrawSubHeader()
        {
            foreach (string subHeader in subHeaderLines)
            {
                ...
                else
                {
                    ...
                    // sin las proximas dos lineas no imprime dotline en subheader
                   // line = DottedLine(); 
        ...
        private void DrawInfoCAE()
        {
            foreach (string footer in infoCAE)
            {
